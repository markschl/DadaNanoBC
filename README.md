...
1. [Primer design](https://markschl.github.io/DadaNanoBC/articles/primers.html)
   ([example report](https://markschl.github.io/DadaNanoBC/primer-design-example.html))
...
*Conda package manager* (e.g. [Conda-forge](https://conda-forge.org/download)) (run in the [bash console](#running-in-the-bash-console)):
